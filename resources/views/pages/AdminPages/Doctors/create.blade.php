...
<div class="d-flex justify-content-center vh-100 h-100">
                ...
                <form action="{{ route('doctors.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <input type="text" name="name" value="{{ old('name') }}" class="form-control rounded-0 border-dark border-1">
                        @error('name')
                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <input type="email" name="email" value="{{ old('email') }}" class="form-control rounded-0 border-dark border-1">
                        @error('email')
                            <div class="text-danger text-center">{{ $message }}</div>
                        @enderror
                            </div>
 ...
 <label class="form-label fw-bold h5">Password:</label>
                            ...
                            <div class="col-md-7">
<input type="password" name="password" class="form-control rounded-0 border-dark border-1">
                        @error('password')
                            <div class="text-danger text-center">{{ $message }}</div>
                        @enderror
                            </div>
                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <input type="password" class="form-control rounded-0  border border-1 border-dark" name="password_confirmation" id="">
                            </div>
                        </div>
                    </div>
  ...
  <label class="form-label fw-bold h5">Phone:</label>
                            ...
                            <div class="col-md-7">
  <input type="text" name="phone" value="{{ old('phone') }}" class="form-control rounded-0 border-dark border-1">
                        @error('phone')
                            <div class="text-danger text-center">{{ $message }}</div>
                        @enderror
                            </div>
                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <textarea name="qualifications" rows="3" class="form-control border border-1 border-dark rounded-0" style="resize: none;">{{ old('qualification') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        @error('profile_picture')
                            <div class="text-danger text-center">{{ $message }}</div>
                        @enderror
                        <img src="" id="preview" alt="" class="d-block mx-auto mt-2" style="max-width: 150px;">
                            </div>

            ...
            <form action="{{route('departments.store')}}" method="POST">
                ...
                <div class="mb-3">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="department_name" placeholder="Enter Department Nae Here..." class="form-control">
                        </div>
                    </div>
                 ...
                 <div class="mb-3">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                           <textarea name="description" placeholder="Enter Description for Department" class="form-control" id="description" cols="30" rows="5"></textarea>
                        </div>
                    </div>
                    @error('description')
                        <p class="text-center text-danger">{{$message}}</p>

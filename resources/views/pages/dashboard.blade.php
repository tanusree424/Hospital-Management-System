            ...
            <div class="col-12">
                <div class="p-4 rounded shadow text-white"
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                        ...
                        <div class="mx-4">
                            <img src="{{ asset('custome Assets/img/dashboard-icon.png') }}" alt="Dashboard Icon" width="70"
                                height="70" class="shadow rounded-circle" />
                        </div>
                        ...
                        <div class="text-center text-md-end">
                            ...
                            @if ($isDoctor && $doctor && $doctor->profile_picture)
                                <img src="{{ asset('storage/' . $doctor->profile_picture) }}"
                                    class="rounded-circle mb-2 border border-white" width="60" height="60"
                                    style="object-fit: cover;" alt="Doctor Profile Image">
                            @elseif ($isPatient && $patient && $patient->patient_image)
                                <img src="{{ asset('storage/' . $patient->patient_image) }}"
                                    class="rounded-circle mb-2 border border-white" width="60" height="60"
                                    style="object-fit: cover;" alt="Patient Profile Image">
                            @elseif ($isAdmin && $admin && $admin->profile_picture)
                                <img src="{{ asset('storage/' . $admin->profile_picture) }}"
                                    class="rounded-circle mb-2 border border-white shadow" width="60" height="60"
                                    style="object-fit: cover;" alt="Admin Profile Image">
                            @else
                                <div class="bg-white rounded-circle mb-2 d-inline-block" style="width:60px; height:60px;">
                                </div>
                            @endif
        ...
        <div class="row g-4">
            ...
            @can('access_blog')
                <div class="col-md-4 col-lg-3">
                    <div class="card shadow-sm border-0 rounded-4 h-100">
                        <div class="card-body text-center">
                            <div class="mb-3">
                                <i class="bi bi-journal fs-1 text-success"></i>
                            </div>
                            <h4 class="fw-bold mb-3">Blogs</h4>
                            <p class="fs-5">Total Blogs:</p>
                            <h2 class="display-5 text-danger fw-bold">{{ $blogCount }}</h2>
                        </div>
                    </div>
                </div>
            @endcan
            @can('access_service')
                <div class="col-md-4 col-lg-3">
                    <div class="card shadow-sm border-0 rounded-4 h-100">
                        <div class="card-body text-center">
                            <div class="mb-3">
                                <i class="bi bi-gear-fill me-2 fs-1 text-secondary"></i>
                            </div>
                            <h4 class="fw-bold mb-3">Services</h4>
                            <p class="fs-5">Total Services:</p>
                            <h2 class="display-5 text-danger fw-bold">{{ $servicesCount }}</h2>
                        </div>
                    </div>
                </div>
            @endcan
            <div class="col-md-4 col-lg-3">
                <div class="card shadow-sm border-0 rounded-4 h-100">
                    <div class="card-body text-center">
                        <div class="mb-3">
                            <i class="fas fa-comment me-2 fs-1 text-primary"></i>
                        </div>
                        <h4 class="fw-bold mb-3">Feedback</h4>
                        <p class="fs-5">Total Feedback:</p>
                        <h2 class="display-5 text-danger fw-bold">{{ $feedbackCount }}</h2>
                    </div>
                </div>
            </div>
        </div>

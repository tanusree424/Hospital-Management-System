                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="{{ route('pricing') }}"
                            class="nav-item nav-link {{ request()->routeIs('pricing') ? 'active' : '' }} ">Pricing</a>
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="{{ route('appointment') }}"
                                    class="dropdown-item {{ request()->routeIs('appointment') ? 'active' : '' }}">Appointment</a>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="{{ route('admin.login') }}" class="dropdown-item">Doctor</a>
                                <a href="{{ route('admin.login') }}" class="dropdown-item">Patient</a>
                                <hr>
        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    ...
                    <div class="pt-2">
                        <a href="{{route('search.page')}}" class="btn btn-light rounded-pill py-md-3 px-md-5 mx-2">Find Doctor</a>
                        <a href="{{ route('appointment') }}"
            ...
            <div class="row gx-5">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded" src="{{ asset('assets/img/about.jpg') }}"
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-sm-6">
                                    <select class="form-select bg-light border-0"
                                        data-url="{{ url('/get-doctors') }}" name="department_id" id="department_id"
                                        style="height: 55px;">
                                ...
                                <div class="col-12 col-sm-6">
                                    <select class="form-select bg-light border-0" name="doctor_id" id="doctor_id"
                                        style="height: 55px;">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="input-group time" id="timepicker1" data-target-input="nearest"
                                        ...
                                        <input type="text" name="appointment_time"
                                            class="form-control datetimepicker-input bg-light border-0"
                                            placeholder="Select Time" data-target="#timepicker1"
                                            style="height: 55px;" />
                ...
                @foreach ($departments as $dept)
                    <div class="bg-light rounded text-center">
                        <div class="position-relative">
                            <img class="img-fluid rounded-top" src="{{ asset('storage/' . $dept->department_image) }}"
                                alt="">
                            <div class="position-absolute w-100 h-100 top-50 start-50 translate-middle rounded-top d-flex flex-column align-items-center justify-content-center"
                                ...
                                <h3 class="text-white">{{ $dept->name }}</h3>
                                <h1 class="display-4 text-white mb-0">
                                    <small class="align-top fw-normal"
                                        style="font-size: 22px; line-height: 45px;">₹</small>{{ $dept->pricing }}<small
                        ...
                        <div class="text-center py-5">
                            ...
                            <a href="{{ route('appointment.dept.book', $dept->id) }}"
                                class="btn btn-primary rounded-pill py-3 px-5 my-2">Apply Now</a>
                        </div>
                    </div>
                @endforeach
            </div>
                    ...
                    <div class="team-item">
                        <div class="row g-0 bg-light rounded overflow-hidden">
                            <div class="col-12 col-sm-5 h-100">
                                <img class="img-fluid h-100" src="{{ asset('storage/' . $doctor->profile_picture) }}"
                                    style="object-fit: cover;">
                            </div>
                            <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                                <div class="mt-auto p-4">
                                    <h3>{{ $doctor->user->name }}</h3>
                                    <h6 class="fw-normal fst-italic text-primary mb-4">{{ $doctor->department->name }}
                                    </h6>
                                    <p class="m-0">{{ $doctor->qualifications }}</p>
                                </div>
        ...
        <div class="container py-5">
            ...
            <div class="mx-auto" style="width: 100%; max-width: 600px;">
                <div class="input-group">
                    <select class="form-select border-primary w-25" name="department_id" style="height: 60px;">
                    ...
                    <input type="text" class="form-control border-primary w-50" name="keyword" placeholder="Keyword">
                                ...
                                <div class="testimonial-item text-center">
                                    <div class="position-relative mb-5">
                                        <img class="img-fluid rounded-circle mx-auto"
                                            src="{{ asset('storage/' . $patient->patient_image) }}" alt="">
